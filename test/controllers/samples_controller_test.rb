...
class SamplesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sample" do
    assert_difference('Sample.count') do
      post samples_url, params: { sample: { project_id: @sample.project_id, title: @sample.title } }
    end
  ...
  test "should update sample" do
    patch sample_url(@sample), params: { sample: { project_id: @sample.project_id, title: @sample.title } }
